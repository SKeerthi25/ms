        ...
        <main>
            ...
            <section className="philosophy-section">
                <div className="container philosophy-grid">
                    ...
                    >
                        <span style={{ color: 'var(--accent-color)', letterSpacing: '5px' }}>SINCE 1947</span>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
                            ...
                            <div>
                                <h3 style={{ color: 'var(--accent-color)', fontSize: '2rem' }}>45+</h3>
                                <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>International Awards</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
